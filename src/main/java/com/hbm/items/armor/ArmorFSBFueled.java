...
public class ArmorFSBFueled extends ArmorFSB implements IFillableItem {
	...
	public void addInformation(ItemStack stack, World worldIn, List<String> list, ITooltipFlag flagIn) {
		list.add(this.fuelType.getLocalizedName() + ": " + Library.getShortNumber(getFill(stack) != 0 ? getFill(stack) : 0) + " / " + Library.getShortNumber(getMaxFill(stack) != 0 ? getFill(stack) : 0));
